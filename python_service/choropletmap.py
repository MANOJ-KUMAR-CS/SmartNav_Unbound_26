...
wards_gdf = gpd.read_file(r'F:\Full_Stack_Projects\Smart-Navigation\python_service\TAMIL NADU_ASSEMBLY.geojson')  # Your geometry file

# Step 2: Load the safety score Excel and make points GeoDataFrame
df = pd.read_excel(r'F:\Full_Stack_Projects\Smart-Navigation\python_service\tn_enhanced_safety_analysis_20250915_122616.xlsx')
...
tamilnadu_map.save(r"F:\Full_Stack_Projects\Smart-Navigation\client\public\tamilnadu_safety_zone_choropleth.html")
print("Map saved as 'tamilnadu_safety_zone_choropleth.html' in client/public")
