...
def gen_route():
    ...
    # Get route
    try:
        route_coords, distance, duration = get_route_osrm(from_lat, from_lon, to_lat, to_lon, profile=mode)
...
def generate_and_save_route():
    ...
    try:
        filename, _ = generate_map(from_place, to_place, mode, r'F:\Full_Stack_Projects\Smart-Navigation\client\public')
    except Exception as e:
